...
\url{https://github.com/daniel-lara-ec/LaTeX_Guias.git}. Cualquier aporte (\emph{Pull request}) será de gran ayuda para mejorar este material. 
...
%% --> Datos de las guias
\universidad{Alephsub0 Editorial}
\autor{Daniel Lara}
\materia{Introducción a LaTeX}

%% --> Logos de las guias
\logouno[2cm]{Imagenes/LogoAleph0-leyenda.png}
\fecha{Semestre 2020-B}